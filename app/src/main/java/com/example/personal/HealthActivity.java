...
public class HealthActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public RecyclerView recyclerhealth ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerhealth = findViewById(R.id.RecyclerView_health);
        recyclerhealth.setHasFixedSize(true);
        Manager = new LinearLayoutManager(this);
        Adapter = new MyThirdAdapter(items);
        recyclerhealth.setLayoutManager(Manager);
        recyclerhealth.setAdapter(Adapter);
        Adapter.setOnItemClickListener(new MyThirdAdapter.OnItemClickListener() {
            ...
            public void onItemclick(int position) {
                ...
                String pose;
                Intent General = new Intent(HealthActivity.this,GeneralActivity.class) ;
                String name = "Health";
            ...
            public void onDoneclick(int position) {
                ...
                if(x>(lvl +1)* 10){
                    lvl++;
                    Toast.makeText(HealthActivity.this, "Level Up", Toast.LENGTH_SHORT).show();
                    x= x - (lvl +1) * 10;
                    wd=1;
                    if(x<0){
                        x = x*(-1);
                ...
                //Toast.makeText(HealthActivity.this,"Done Clicked..and subject = ",Toast.LENGTH_SHORT).show();
            }
            ...
            public void onCheckclick(int position) {
                ...
                items.remove(position);
                Adapter.notifyDataSetChanged();
                //Toast.makeText(HealthActivity.this,"Check Clicked..",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.nav_general:
                Intent generalIntent = new Intent(HealthActivity.this, GeneralActivityM.class);
            ...
            case R.id.nav_friends:
                Intent Social = new Intent(HealthActivity.this, SocialActivity.class);
                startActivity(Social);
                break;
            case R.id.nav_events:
                Intent eventIntent = new Intent(HealthActivity.this, EventsActivity.class);
    ...
    private void getData(DatabaseReference dbf, String id){
        dbf.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(flag == 0){
                    for(int i=0;i<10;i++){
                        String m = snapshot.child("Category").child(id).child("Health").child(String.valueOf(i)).child("Subject").getValue(String.class);
                        if(m.equals(""))
                            i++ ;
                        else
                        {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(flagNCS == 0){
                    ...
                    for(i=0,NumberChekersub = "0";i<10;i++){
                        String nn = snapshot.child("Category").child(uid).child("Health").child(String.valueOf(i)).child("Subject").getValue(String.class);
                        ...
                        if(nn.equals(sub)){
                            ...
                            if(flagNCS == 0){
                                ...
                                FirebaseDatabase.getInstance().getReference().child("Category").child(uid).child("Health").child(NumberChekersub).child("Date")
                                        .setValue("");
                                FirebaseDatabase.getInstance().getReference().child("Category").child(uid).child("Health").child(NumberChekersub).child("Description")
                                        .setValue("");
                                FirebaseDatabase.getInstance().getReference().child("Category").child(uid).child("Health").child(NumberChekersub).child("Subject")
                                        .setValue("");
                                FirebaseDatabase.getInstance().getReference().child("Category").child(uid).child("Health").child(NumberChekersub).child("Time")
                                        .setValue("");
